// gw: we can get the coordinate of node via its index
 ...
 *  @author Kevin Wayne
 */
public class DoubleLinkedEdgeWeightedDigraph {
    private final int V;
    private int E;
    private Bag<DirectedEdge>[] adj;
    private Bag<DirectedEdge>[] adj_rev;
     ...
     */
    public DoubleLinkedEdgeWeightedDigraph(int V) {
        if (V < 0) throw new IllegalArgumentException("Number of vertices in a Digraph must be nonnegative");
        this.V = V;
        this.E = 0;
        adj = (Bag<DirectedEdge>[]) new Bag[V];
        adj_rev = (Bag<DirectedEdge>[]) new Bag[V];
        for (int v = 0; v < V; v++) {
            adj[v] = new Bag<DirectedEdge>();
            adj_rev[v] = new Bag<DirectedEdge>();
        }
     ...
     */
    // TODO: modify for adj_rev later
//    public DoubleLinkedEdgeWeightedDigraph(int V, int E) {
//        this(V);
...
//    }
     ...
     */
    //TODO: modify for adj_rev
//    public DoubleLinkedEdgeWeightedDigraph(In in) {
//        this(in.readInt());
//        int E = in.readInt();
...
//    }
     ...
     */
    //TODO: modify for adj_rev
//    public DoubleLinkedEdgeWeightedDigraph(DoubleLinkedEdgeWeightedDigraph G) {
//        this(G.V());
//        this.E = G.E();
//        for (int v = 0; v < G.V(); v++) {
...
//    }
    ...
    /**
     * Returns the directed edges incident to vertex <tt>w</tt>
     * @return the directed edges incident to vertex <tt>w</tt> as an Iterable
     * @param w
     * @return
     */
    public Iterable<DirectedEdge> adj_rev(int w) {
        if (w < 0 || w >= V) throw new IndexOutOfBoundsException("vertex " + w + " is not between 0 and " + (V-1));
        return adj_rev[w];
    }
